...
const STRONG_PASSWORD_RE = /^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[^a-zA-Z0-9]).{8,}$/;
/**
...
export function generatePassword(options = {}) {
    const { length = 8, useUppercase = true, useLowercase = true, useDigits = true, useSpecial = true, specialChars = PUNCTUATION, } = options;
 ...
 */
export function generatePasswordSuggestions(count = 3, length = 16) {
    const suggestions = [];
...
//# sourceMappingURL=password-gen.js.map